...
const WhyGreenCirkit = () => {
  const advantages = [
    ...
    },
    {
      ...
      description: "Competitive pricing with 15% lower EPR costs compared to market alternatives"
    },
    {
      icon: MapPin,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-primary/5 to-green-accent/5 rounded-3xl p-8 backdrop-blur">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center bg-card/80 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
